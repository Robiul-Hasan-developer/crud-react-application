  ...
  return (
    <>
      <table className="table-fixed xl:w-full">
        <thead>
          <tr>
            <th className="py-5 px-4 font-semibold capitalize text-base bg-neutral-200 text-start w-[238px]"></th>
            <th className="py-5 px-4 font-semibold capitalize text-base bg-neutral-200 text-start">
              Title
            </th>
            <th className="py-5 px-4 font-semibold capitalize text-base bg-neutral-200 text-start w-[238px]">
              Description
            </th>
            <th className="py-5 px-4 font-semibold capitalize text-base bg-neutral-200 text-center w-[238px]">
              Tags
            </th>
            <th className="py-5 px-4 font-semibold capitalize text-base bg-neutral-200 text-center  w-[238px]">
              Priority
        ...
        <table className="table-fixed overflow-auto xl:w-full">
          <tbody className="max-h-[300px] overflow-y-auto">
            {tasks.map((task) => (
              ...
              >
                {/* Star */}
                <td className="w-[238px] !align-middle text-start">
                  <button
                    type="button"
                ...
                {/* Title */}
                <td className="w-[238px] !align-middle text-start">{task.title}</td>
                ...
                {/* Tags */}
                <td className="w-[238px] !align-middle !py-5 px-4">
                ...
                {/* Priority */}
                <td className="w-[238px] !align-middle text-center">
                  <span
                    className={`px-4 py-1 text-sm font-semibold rounded inline-flex justify-center capitalize
                      ${
                        task.priority === "high" &&
